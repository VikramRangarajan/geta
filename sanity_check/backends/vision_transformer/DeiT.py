...
class VisionTransformerDistilled(VisionTransformer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.pos_embed = nn.Parameter(
            torch.zeros(
                1, self.patch_embed.num_patches + self.num_prefix_tokens, self.embed_dim
            )
        )
        self.head_dist = (
...
def deit_small_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_deit(
        "deit_small_patch16_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def deit_base_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_deit(
        "deit_base_patch16_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def deit_base_patch16_384(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model_args = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12)
    model = _create_deit(
        "deit_base_patch16_384", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def deit3_small_patch16_384(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_deit(
        "deit3_small_patch16_384", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def deit3_medium_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_deit(
        "deit3_medium_patch16_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def deit3_base_patch16_384(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_deit(
        "deit3_base_patch16_384", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def deit3_large_patch16_384(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_deit(
        "deit3_large_patch16_384", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def deit3_huge_patch14_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_deit(
        "deit3_huge_patch14_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
