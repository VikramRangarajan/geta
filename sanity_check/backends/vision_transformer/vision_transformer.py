...
default_cfgs = {
    ...
    "vit_base_patch32_clip_224.laion2b": _cfg(
        hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, num_classes=512
    ),
    ...
    "vit_base_patch16_siglip_256.webli": _cfg(
        hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0
    ),
    "vit_base_patch16_siglip_256.webli_i18n": _cfg(
        hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0
    ),
    "vit_base_patch16_siglip_384.webli": _cfg(
        hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0
    ),
    "vit_base_patch16_siglip_512.webli": _cfg(
        hf_hub_id="timm/", input_size=(3, 512, 512), num_classes=0
    ),
    ...
    "vit_so400m_patch14_siglip_224.webli": _cfg(hf_hub_id="timm/", num_classes=0),
    "vit_so400m_patch16_siglip_256.webli_i18n": _cfg(
        hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0
    ),
    "vit_so400m_patch14_siglip_378.webli": _cfg(
        hf_hub_id="timm/", input_size=(3, 378, 378), num_classes=0
    ),
    ...
    "vit_so400m_patch14_siglip_gap_378.webli": _cfg(
        hf_hub_id="timm/", input_size=(3, 378, 378), crop_pct=1.0, num_classes=0
    ),
    "vit_so400m_patch14_siglip_gap_384.webli": _cfg(
        hf_hub_id="timm/", input_size=(3, 384, 384), crop_pct=1.0, num_classes=0
    ),
    "vit_so400m_patch14_siglip_gap_448.pali_mix": _cfg(
        hf_hub_id="timm/", input_size=(3, 448, 448), crop_pct=1.0, num_classes=0
    ),
    ...
    "vit_so400m_patch14_siglip_gap_896.pali_pt": _cfg(
        hf_hub_id="timm/", input_size=(3, 896, 896), crop_pct=1.0, num_classes=0
    ),
    ...
    "test_vit4.r160_in1k": _cfg(input_size=(3, 160, 160), crop_pct=0.95),
}
...
@register_model
def vit_so150m_patch16_reg4_gap_384(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    """SO150M (shape optimized, but diff than paper def, optimized for GPU)"""
    model_args = dict(
...
@register_model
def vit_so150m2_patch16_reg1_gap_256(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
...
def aimv2_large_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model_args = dict(
        ...
        embed_norm_layer=partial(RmsNorm, eps=1e-5),
        mlp_layer=SwiGLU,
    )
    model = _create_vision_transformer(
...
def test_vit4(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer(
        "test_vit4", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
