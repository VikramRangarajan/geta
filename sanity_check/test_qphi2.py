...
class TestQPhi2(unittest.TestCase):
    def test_sanity(self):
        phi_config = PhiConfig()
        phi_config.n_layer = 4
        ...
        oto = OTO(q_model, dummy_input=(input_data,), strict_out_nodes=True)
        ...
        print(
            "Maximum output difference under the different inputs: ", max_output_diff_3
        )
        print(
            "Maximum output difference under the different inputs: ", max_output_diff_4
        )
